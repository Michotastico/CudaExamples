...
static CUresult initCUDA(char*, CUfunction *pMatrixMul);
...
runTest(int /*argc*/, char** argv)
{
    ...
    CU_SAFE_CALL(initCUDA(argv[0], &matrixMul ));
...
initCUDA(char* executablePath, CUfunction *pMatrixMul )
{
    ...
    module_path = cutFindFilePath("matrixMul_kernel.cubin", executablePath);
    if (module_path == 0) {
